...
###
        ## MR: my fix to correct the unicode utf-8 error
        infile_init = open(options['infile'], 'r')
        num_spec=1
        if file_type != 'fits':  # enter if it is a text file
