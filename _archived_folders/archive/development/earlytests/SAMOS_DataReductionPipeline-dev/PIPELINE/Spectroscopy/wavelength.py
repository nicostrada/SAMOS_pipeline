# -*- coding: utf8 -*-
"""
Adapted for SAMOS from Goodman Pipeline
https://github.com/soar-telescope/goodman_pipeline/blob/master/goodman_pipeline/spectroscopy/wavelength.py
...
class WavelengthCalibration:
    ...
    def __call__(self,
        ...
        print(os.path.isdir(reference_data))
    ...
    def _automatic_wavelength_solution(self,
        ...
        slit_size = float('2.55') #float(re.sub('["A-Za-z_ ]', '', self.lamp.header['SLIT']))
        ...
        for i in range(len(lamp_lines_pixel)):
            ...
            slit_size = float('2.5')#float(re.sub('["A-Za-z_ ]', '', self.lamp.header['SLIT']))
